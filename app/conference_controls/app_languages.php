...
$text['title-conference_controls']['sv-se'] = "Konferens Inställningar";
...
$text['title-conference_control']['sv-se'] = "Konferenskontroll";
...
$text['title_description-conference_control']['sv-se'] = "Samtalskontroller möjliggör förmåga att tilldela siffror till handlingar. De kan användas för att stänga av, avaktivera eller andra åtgärder under konferenssamtalet.";
...
$text['description-control_name']['sv-se'] = "Ange konferenskontrollens namn";
...
$text['description-control_enabled']['sv-se'] = "Sätt status på kontrollen";
...
$text['title-conference_control_detail']['sv-se'] = "Kontroll";
