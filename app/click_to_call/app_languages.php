...
$text['label-src-caller-id-nam']['sv-se'] = "Nummerpresentation Namn för källa";
...
$text['desc-src-caller-id-nam']['sv-se'] = "Ange nummerpresentation namn som skall skickas till din telefon.";
...
$text['label-dest-caller-id-nam']['sv-se'] = "Destination nummerpresentation namn.";
...
$text['desc-dest-caller-id-nam']['sv-se'] = "Ange nummerpresentation namnet för att skicka till destinationsnumret.";
...
$text['label-dest-caller-id-num']['sv-se'] = "Destination nummerpresentation nummer.";
...
$text['desc-dest-caller-id-num']['sv-se'] = "Ange uppringningsnummeret för att skicka till destinationsnumret (du vill säkert att detta ska vara ditt telefonnummer).";
...
$text['label-src-num']['sv-se'] = "Käll nummer";
...
$text['desc-dest-num']['sv-se'] = "Ange numret som ska ringas. Detta kan vara en anknytning i systemet, ett annat nummer eller en sip uri. SIP URIs i formen 5551234567@voip.example.com: 5080 (5080 för freeswitch eller 5060 för andra system).";
...
$text['desc-auto-answer']['sv-se'] = "Välj om du vill aktivera automatiskt svar.";
...
$text['desc-record']['sv-se'] = "Välj om du vill spela in samtalet.";
...
$text['label-ringback']['sv-se'] = "Tillbaka Ringning";
